...
public class CatListActivity extends ListActivity {
	...
	// category list API
	private static String catUrl = "http://yusufmansur.com/wp-json/taxonomies/category/terms/";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new ProgressTask(CatListActivity.this).execute();
	}
	...
	private class ProgressTask extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPostExecute(final Boolean success) {
			...
			ListAdapter adapter = new SimpleAdapter(context, jsonList,
					R.layout.catlist_item, new String[] { TAG_ID, TAG_CAT,
		...
		protected Boolean doInBackground(final String... args) {
			...
			JSONArray json = jParser.getJSONFromUrl(catUrl);
